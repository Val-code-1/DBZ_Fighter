...
function updateHealth(name) {
  switch (name) {
    case "Goku":
      gokuHealth.textContent = goku.health;
      break;
    case "Vegeta":
      vegetaHealth.textContent = vegeta.health;
      break;
    case "Broly":
      brolyHealth.textContent = broly.health;
      break;
    case "Piccolo":
      piccoloHealth.textContent = piccolo.health;
      break;
    case "Dende":
      dendeHealth.textContent = dende.health;
      break;
    case "Frieza":
      friezaHealth.textContent = frieza.health;
      break;
    default:
      return;
  }
...
function updatePowerLevel(name) {
  switch (name) {
    case "Goku":
      gokuPower.textContent = goku.powerLevel;
      break;
    case "Vegeta":
      vegetaPower.textContent = vegeta.powerLevel;
      break;
    case "Broly":
      brolyPower.textContent = broly.powerLevel;
      break;
    case "Piccolo":
      piccoloPower.textContent = piccolo.powerLevel;
      break;
    case "Dende":
      dendePower.textContent = dende.powerLevel;
      break;
    case "Frieza":
      friezaPower.textContent = frieza.powerLevel;
      break;
    default:
      return;
  }
